...
const Skills = () => {
  return (
    <section id="skills" className="w-full">
      <div className="flex flex-row justify-between items-center flex-wrap gap-x-2  md:gap-x-6 ">
        <Link href="https://nextjs.org/">
          <a className="relative w-12 md:w-36  h-20 link">
            <Image src="/nextjs.svg" layout="fill" alt="" objectFit="contain" />
          </a>
        </Link>
        <Link href="https://expressjs.com/">
          <a className="relative w-12 md:w-36  h-28 link">
            <Image
              src="/expressjs.svg"
              layout="fill"
              alt=""
        ...
        <Link href="https://greensock.com/gsap/">
          <a
            ...
            className="relative w-12 md:w-36  h-28 link "
          >
            <Image
              src="/gsap.svg"
              layout="fill"
